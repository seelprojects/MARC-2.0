    ...
    internal static class ComponentFactory
    {
        public static IWordStemmer CreateWordStemmer(bool groupSameStemWords)
        {
            return groupSameStemWords
                       ? (IWordStemmer)new Gma.CodeCloud.Controls.TextAnalyses.Stemmers.En.PorterStemmer()
                       : new NullStemmer();
        }
        ...
        public static IProgressIndicator CreateProgressBar(InputType inputType, System.Windows.Forms.ProgressBar progressBar)
        {
            return
